...
$tbrowser_url = "https://jsroot.gsi.de/latest/?dir=https://" . $_SERVER['SERVER_NAME'] . $current_folder . "/";
...
function show_entry($name)
{
  ...
  } else if ($search_pattern_mode == "all") {
...
<body>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form class="d-flex">
          <div class="input-group">
            ...
            &nbsp;
            <input type="checkbox" name="regexp" <?php if (isset($_GET['regexp']) && $_GET['regexp']) print "checked=\"checked\""; ?>>RegExp</input>
          </div>
        </form>
  ...
  <button class="btn btn-outline-primary btn-sm" onclick="window.location.href='<?php echo $tbrowser_url; ?>'">Open TBrowser</button>
  <!-- list plots -->
          ...
          foreach ($additional_extensions as $ext) {
            ...
            if (file_exists($other) && show_entry($other)) {
              ...
              if ($ext == "png") {
                ...
                $badge_style = "secondary"; // "light" is not readable
              }
